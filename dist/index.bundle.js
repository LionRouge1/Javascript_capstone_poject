    ...
    /***/ ((module) => {
      module.exports = function (item) {
        ...
        if (typeof btoa === 'function') {
          ...
          var sourceURLs = cssMapping.sources.map((source) => '/*# sourceURL='.concat(cssMapping.sourceRoot || '').concat(source, ' */'));
